...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    setIsLoading(true);
    // Timeout allows the loading state to render before redirecting
    setTimeout(() => {
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full btn btn-primary flex items-center justify-center gap-3 py-3 disabled:opacity-75"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
