        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="w-full btn btn-primary flex items-center justify-center gap-3 py-3 transition-colors hover:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500 disabled:bg-primary-400 disabled:cursor-not-allowed"
